                ...
                <div class="card-block">
                    ...
                    <div class="row m-t-40">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h1 class="m-b-0">65<small>%</small></h1>
                            <h6 class="text-muted">160 Sales January</h6>
                            <ul class="list-icons m-t-30">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-block">
                    <ul class="list-inline pull-right">
                        <li>
                            <h6 class="text-muted"><i class="fa fa-circle m-r-5 text-success"></i>Net</h6>
                        </li>
                        <li>
                            <h6 class="text-muted"><i class="fa fa-circle m-r-5 text-info"></i>Growth</h6>
                        </li>
                    </ul>
